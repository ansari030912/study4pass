...
import ScAccesVideoCourse from "@/app/components/VideoCards/ScAccesVideoCourse";
          ...
          <div className="w-full lg:w-7/12 px-4 xl:pl-12">
            <div className="max-w-4xl mb-6">
              ...
              <p className="text-base text-gray-400">
                Prepare to elevate your knowledge and skills with our
                comprehensive certification training course, meticulously
                designed to ensure your success. This {data?.title} course
                offers a full suite of instructional videos that break down
                complex concepts into easy-to-understand lessons, making it
                easier for you to grasp even the most challenging topics.
              </p>
              <p className="text-base font-semibold text-red-500 mt-3">
                <span className="text-red-500">Note:</span> Click on any lecture
                title below to access the next video in your course. Each video
                is part of the same comprehensive training, designed to guide
                you step-by-step toward certification success.
              </p>
            </div>
            <div className="flex max-w-3xl justify-between border-b pb-3 mb-3">
