...
const MainPageHeroSection = () => {
  return (
    <section class="pb-12 lg:pb-32">
      <div
        class="mb-40 md:mb-12 py-20 bg-cover bg-no-repeat bg-center"
        style={{
        ...
        <div class="relative container px-4 mx-auto">
          <div class="w-full xl:w-1/2 px-4 mb-24 xl:mb-0">
            <div class="max-w-md md:max-w-2xl mx-auto">
              <div class="text-sm mb-2 font-semibold text-white uppercase">
                <span>Develop Your</span>
                <span class="text-blue-500"> Skills</span>
              </div>
              <h1 class="font-heading text-4xl md:text-5xl text-white mb-6">
                Efficiently Conquer Your Next Certification Exam!
              </h1>
              <p class="text-lg leading-8 text-white mb-10">
              ...
              <div class="sm:flex items-center">
                ...
                <Link
                  class="inline-block w-full sm:w-auto py-4 px-6 text-center font-heading font-medium text-base text-white hover:text-blue-500 border border-white hover:border-blue-500 rounded-sm transition duration-150"
                  href="#"
                >
                  Unlimited Access
                </Link>
          ...
          <img
            class="xl:absolute top-0 right-0 block mx-auto lg:mr-20 -mb-52 xl:-mb-0"
